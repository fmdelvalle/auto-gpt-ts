import { Env, ICliArguments, ICommandCategory, ILogger, IPlugin, IRunParameters } from "../types";
...
// @ts-ignore
export async function run_auto_gpt( cfg: ICliArguments, env: Env, extra_loggers: Partial<ILogger>[] ) {
...
/*    
    ...
    */
    ...
    const logger = await prepare_complete_logger( workspace_directory, extra_loggers );
